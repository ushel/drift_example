...
from drift_detector1 import detect_drift
...
def log_experiment(model, report, roc_auc):
    with mlflow.start_run():
        ...
        mlflow.log_artifact("Data\outputs\model.pkl")
...
#         joblib.dump(y_pred, "Data\outputs\predictions.pkl")
#         mlflow.log_artifact("Data\outputs\predictions.pkl")
def log_inference_metrics(y_true, y_pred, drift_report=None):
    report = classification_report(y_true, y_pred, output_dict=True)
    
    # Use weighted average to support binary or multiclass targets
